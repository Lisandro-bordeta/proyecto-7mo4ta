...
const TerminosYCondiciones = () => {
    ...
    const styles = {
        body: { // Estilos del body aplicados al div principal
        ...
        <div style={styles.body}> 
            ...
            <section id="informacion-general" style={styles.section}>
                ...
                <ul>
                    ...
                    {/* El atributo 'href' se mantiene igual */}
            ...
            <footer>
                ...
                <p>
                    {/* Nota: En React, si usas React Router, estos enlaces se reemplazarían por componentes <Link> */}
