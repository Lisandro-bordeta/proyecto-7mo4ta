// components/TerminosYCondiciones.jsx
import React from 'react';
import styles from '../styles/Docs.module.css'; // Importamos el CSS Module

const TerminosYCondiciones = () => {
    return (
        // Aplicamos la clase del contenedor general
        <div className={styles.pageContainer}> 
            ...
            <section id="informacion-general" className={styles.section}>
                <h2 className={styles.title}>1. Información General y Aceptación</h2>
                ...
                <h3 className={styles.title}>Datos del Propietario:</h3>
                <ul>
            ...
            {/* ... Resto de Secciones (2 a 7) con la clase className={styles.section} y className={styles.title} ... */}
            
            {/* Sección 2: Proceso de Compra */}
            <section id="proceso-compra" className={styles.section}>
                <h2 className={styles.title}>2. Proceso de Compra y Precios</h2>
            ...
            <section id="pagos" className={styles.section}>
                <h2 className={styles.title}>3. Pagos y Seguridad</h2>
            ...
            <section id="envio-entrega" className={styles.section}>
                <h2 className={styles.title}>4. Envío y Entrega</h2>
            ...
            <section id="devoluciones" className={styles.section}>
                <h2 className={styles.title}>5. Cambios, Devoluciones y Derecho de Desistimiento</h2>
            ...
            <section id="propiedad-intelectual" className={styles.section}>
                <h2 className={styles.title}>6. Propiedad Intelectual</h2>
            ...
            <section id="legislacion-aplicable" className={styles.section}>
                <h2 className={styles.title}>7. Ley Aplicable y Jurisdicción</h2>
            ...
            <footer>
                ...
                <p>
                    {/* Usar el componente <Link> de Next.js es la mejor práctica, aquí usamos <a> simple */}
